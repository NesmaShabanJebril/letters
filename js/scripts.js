	...
	$('#carousel-package').on('slide.bs.carousel', function (e) {
	    ...
	    */
	    ...
	    var idx = $e.index();
	    var itemsPerSlide = 5;
	    var totalItems = $('#carousel-package  .carousel-item').length;
	    ...
	    if (idx >= totalItems-(itemsPerSlide-1)) {
	        ...
	        for (var i=0; i<it; i++) {
	            // append slides to end
	            if (e.direction=="left") {
	                $('#carousel-package .carousel-item').eq(i).appendTo('#carousel-package  .carousel-inner');
	            }
	            else {
	                $('#carousel-package .carousel-item').eq(0).appendTo('#carousel-package .carousel-inner');
	            }
	        }
	    }
	});
